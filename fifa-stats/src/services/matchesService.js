  ...
  try {
    ...
    const { data: matchResult, error: matchError } = await supabase
      ...
      .insert([{
        ...
        home_team_id: matchData.is_home_match ? matchData.player_team_id : matchData.opponent_team_id,
        away_team_id: matchData.is_home_match ? matchData.opponent_team_id : matchData.player_team_id,
        home_score: matchData.home_score,
        away_score: matchData.away_score,
        is_home_match: matchData.is_home_match,
        team_id: matchData.player_team_id,
